...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#fbf5f3;padding:32px 16px;">
<tr><td align="center">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#ffffff;border-radius:16px;overflow:hidden;font-family:ui-sans-serif,system-ui,-apple-system,'Segoe UI',sans-serif;">
    ...
    <tr><td style="padding:32px 32px 8px;">
      <p style="margin:0 0 12px;font-size:12px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#666666;">${label}</p>
...
<tr><td align="center">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#ffffff;border-radius:16px;font-family:ui-sans-serif,system-ui,-apple-system,'Segoe UI',sans-serif;">
    <tr><td style="padding:32px 32px 8px;">
      <h1 style="margin:0 0 12px;font-size:24px;line-height:1.25;color:#000000;font-weight:700;">${escape(heading)}</h1>
      <p style="margin:0 0 24px;font-size:16px;line-height:1.55;color:#666666;">${escape(body)}</p>
      <p style="margin:0 0 28px;">
        <a href="${escape(url)}" style="display:inline-block;padding:13px 22px;border-radius:999px;background:#000000;color:#ffffff;text-decoration:none;font-weight:600;font-size:15px;">${escape(action)}</a>
      </p>
      <p style="margin:0 0 32px;font-size:13px;line-height:1.5;color:#666666;">${escape(ignore)}</p>
    </td></tr>
  </table>
</td></tr></table>
</body></html>`
